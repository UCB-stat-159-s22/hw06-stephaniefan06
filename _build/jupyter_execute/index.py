...
# This function is moved to utils.py package
...
for det in dets:
    ...
    if make_plots:
        ...
        # see ploting codes in utils package
        utils.plot_detectors(det, time, timemax, SNR, pcolor, tevent, data, 
                       strain_whitenbp, template_match, template_fft, 
                       datafreq, d_eff, freqs, data_psd)
